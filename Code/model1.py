...
classifier.save("savedModel1.h5")
...
if result[0][0] > 0.5:
    ...
    file.write("Accurancy : "+str(result[0][0])+" "+prediction+"---->"+"Attribute : Conv , Pooling , Conv , Pooling , Flatten ,Fully Conn, Correct Result :Benigne\n\n")
    file.close()
else:
    prediction = 'benigne'
    print(prediction)
