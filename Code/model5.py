# -*- coding: utf-8 -*-
"""
Created on Wed Nov 28 10:28:44 2018
...
if result[0][0] > 0.5:
    ...
    file.write("Accurancy : "+str(result[0][0])+"---->"+"Attribute : Conv x 2 , Pooling , Conv x 2 , Pooling , Conv x 2 , Pooling , Flatten ,Fully Conn\n\n")
    file.close()
else:
    prediction = 'benigne'
    print(prediction)
